...
export class LogEntryService {	
    ...
    public getAsset(id: any): Observable<LogEntry> {
      return this.dataService.getSingle(this.NAMESPACE, id);
    }

    public addAsset(itemToAdd: any): Observable<LogEntry> {
      return this.dataService.add(this.NAMESPACE, itemToAdd);
    }

    public updateAsset(id: any, itemToUpdate: any): Observable<LogEntry> {
