...
Feature: Sample
    ...
    Background:
        ...
        And I have added the following participants of type be.vlaanderen.audittrail.SampleParticipant
            | participantId   | firstName | lastName |
            | alice@email.com | Alice     | A        |
            | bob@email.com   | Bob       | B        |
        And I have added the following assets of type be.vlaanderen.audittrail.SampleAsset
            | assetId | owner           | value |
            | 1       | alice@email.com | 10    |
            | 2       | bob@email.com   | 20    |
        And I have issued the participant be.vlaanderen.audittrail.SampleParticipant#alice@email.com with the identity alice1
        And I have issued the participant be.vlaanderen.audittrail.SampleParticipant#bob@email.com with the identity bob1
